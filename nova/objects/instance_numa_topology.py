...
class InstanceNUMACell(base.NovaObject,
    ...
    # Version 1.4: Add cpus_reserved field
    VERSION = '1.4'
    ...
    def obj_make_compatible(self, primitive, target_version):
        ...
        if target_version < (1, 4):
            primitive.pop('cpus_reserved', None)
    ...
    fields = {
        ...
        'cpus_reserved': obj_fields.SetOfIntegersField(nullable=True),
    }
    ...
    def __init__(self, **kwargs):
        ...
        if 'cpus_reserved' not in kwargs:
            self.cpus_reserved = None
            self.obj_reset_changes(['cpus_reserved'])
